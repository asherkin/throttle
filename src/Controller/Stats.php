...
class Stats extends AbstractController
{
    ...
    {
        $data = $this->cache->get('stats_unique', function (ItemInterface $item) {
            $item->expiresAfter(10);
     ...
     */
    public function daily($module = null, $function = null)
    {
     ...
     */
    public function hourly($module = null, $function = null)
    {
        if ($module === null && $function === null) {
     ...
     */
    public function latest(Request $request, $module = null, $function = null)
    {
        $query = null;
